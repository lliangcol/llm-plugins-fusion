...
export function joinLockedLabels(dataset, locked) {
  ...
  return dataset.cases.map((prompt) => {
    ...
    return { ...prompt, expectedRoute: label.preferredRoutes, expectedRequiredInputs: label.expectedRequiredInputs, acceptableRoutes: label.acceptableRoutes, forbiddenRoutes: label.forbiddenRoutes };
  });
}
