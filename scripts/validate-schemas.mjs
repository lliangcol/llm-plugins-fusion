...
const targets = [
  ...
  {
    schema: loadJson('schemas/dependency-policy.schema.json'),
    data: loadJson('governance/dependency-policy.json'),
  ...
  {
    schema: loadJson('schemas/dependency-license-evidence.schema.json'),
    data: loadJson('governance/dependency-license-evidence.json'),
    label: 'governance/dependency-license-evidence.json',
  },
