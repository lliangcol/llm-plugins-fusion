...
const targets = [
  ...
  },
  {
    ...
    data: loadJson('evals/live/v5/cases.json'),
    label: 'evals/live/v5/cases.json',
  },
  {
    schema: loadJson('schemas/eval-dataset.schema.json'),
    data: loadJson('evals/live/v5/labels.locked.json'),
    label: 'evals/live/v5/labels.locked.json',
  },
  ...
  {
    schema: loadJson('schemas/dependency-governance.schema.json'),
    data: loadJson('governance/dependency-governance.json'),
    label: 'governance/dependency-governance.json',
  },
  ...
  {
    schema: loadJson('schemas/engineering-evidence.schema.json'),
    data: loadJson('governance/engineering-evidence.json'),
...
const schemaPaths = [
  ...
  'schemas/dependency-license-evidence.schema.json',
