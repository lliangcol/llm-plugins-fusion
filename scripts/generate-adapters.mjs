...
function genericManifest(spec) {
  return {
    schemaVersion: 2,
    source: sourcePath,
    maximumSupportedLevel: 'L4',
    declaredLevel: 'L1',
    evidenceRequiredFor: ['L2', 'L3', 'L4'],
