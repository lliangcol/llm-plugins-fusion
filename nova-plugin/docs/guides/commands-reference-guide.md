...
| 探索 | `/nova-plugin:senior-explore`     | 🔴 强    | 分析报告   | ❌ 禁止    | 深度分析                                         |
| 探索 | ⭐`/nova-plugin:explore`          | 🟡 中    | 视角化分析 | ❌ 禁止    | **统一命令，推荐**                               |
| 探索 | `/nova-plugin:explore-lite`       | 🟡 中    | 简要分析   | ❌ 禁止    | 等价于 `/nova-plugin:explore PERSPECTIVE=observer`           |
| 探索 | `/nova-plugin:explore-review`     | 🟡 中    | 评审问题   | ❌ 禁止    | 等价于 `/nova-plugin:explore PERSPECTIVE=reviewer`           |
| 规划 | `/nova-plugin:plan-lite`          | 🟡 中    | 轻量计划   | ❌ 禁止    | -                                                |
...
| `standard` | `/nova-plugin:review-only`   | 标准代码评审（7 项维度） |
...
| `/nova-plugin:review LEVEL=standard` / `/nova-plugin:review-only` | 核心链路   | 🟡 中 |
