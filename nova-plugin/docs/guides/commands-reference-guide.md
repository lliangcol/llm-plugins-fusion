...
| 场景类别     | 具体场景       | 推荐命令                                               | 跳转                           |
| ------------ | -------------- | ------------------------------------------------------ | ------------------------------ |
| **路由选择** | 不确定下一步命令 | `/route`                                             | [文档](../commands/explore/route.md) |
...
`/route` 是只读第一阶段路由器：先判断请求属于 explore、plan、review、
...
| ---- | --------------------- | -------- | ---------- | ---------- | ------------------------------------------------ |
| 路由 | `/route`              | 🟡 中    | 路由建议   | ❌ 禁止    | 只读第一阶段路由：命令 / skill / agent / pack / 验证建议 |
