...
[![Version](https://img.shields.io/badge/version-3.0.0-blue.svg)](https://github.com/lliangcol/llm-plugins-fusion/releases/tag/v3.0.0)
...
Promote formal release tags such as `v3.0.0`, not a moving `main` branch.
...
| [Marketplace portal IA](../../../docs/marketplace/portal-information-architecture.md) | Marketplace portal information architecture, data sources, current `v3.0.0` single-plugin boundary, and deferred multi-plugin boundary | Evaluating the deferred portal boundary |
