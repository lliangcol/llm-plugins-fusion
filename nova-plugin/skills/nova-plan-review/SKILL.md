...
- Use `/nova-plugin:plan-review` for critical review of an existing plan.
...
Migrated from the pre-thin slash command contract for `/nova-plugin:plan-review` (`nova-plugin/commands/plan-review.md`).
