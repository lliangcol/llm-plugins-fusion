...
- Use `/nova-plugin:review` as the hub for lite, standard, or strict review.
...
Migrated from the pre-thin slash command contract for `/nova-plugin:review` (`nova-plugin/commands/review.md`).
