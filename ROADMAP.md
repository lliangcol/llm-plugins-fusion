...
| 领域 | 当前状态 |
| --- | --- |
| 发布版本 | `nova-plugin` 当前稳定推广版本为 exact release tag `v3.0.0`；移动 `main` 不能替代正式 tag。 |
...
| 发布决策 | `CHANGELOG.md` 的 `2.0.0` release section 已将 active-agent 变化记录为 major release 兼容边界。 |
