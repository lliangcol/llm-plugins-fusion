<!-- migrated-from: docs/prompts/README.md -->
...
- [Thin Harness, Fat Skills Workflow Doctrine](../../reference/architecture/skill-first-projection.md)
- [Consumer Profile Contract](../consumer-profiles/contract.md)
- [Workbench Consumer Template](../consumer-profiles/workbench.md)
