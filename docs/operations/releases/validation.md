<!-- migrated-from: docs/releases/release-validation-runbook.md -->
...
[release-evidence-template.md](../../templates/evidence/release.md) and attach the
manual workflow result from
[../examples/workflow-evaluation-record-template.md](../../templates/evidence/workflow-evaluation.md).
...
[operator-recovery-and-key-rotation.md](recovery-and-key-rotation.md).
...
- [../examples/workflow-evaluation.md](../../tutorials/workflow-evaluation.md)
