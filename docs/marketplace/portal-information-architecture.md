...
| Roadmap and migration | Maintainers and authors | Current `v2.3.0` single-plugin boundary, the `v2.2.0` introduction of that scope, and `v3.0.0` activation evidence | Ready from roadmap, release hygiene, and [v3 readiness evidence](v3-readiness-evidence.md) |
...
remains the current `v2.3.0` marketplace state. It adds routing, runtime smoke, distribution risk scanning, a
...
- This document exists under `docs/marketplace/` and is linked from the project
  navigation.
- The current `v2.3.0` single-plugin boundary, its `v2.2.0` introduction, and
