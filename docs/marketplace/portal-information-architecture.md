...
remains the current `v3.2.0` marketplace state. It adds routing, runtime smoke, distribution risk scanning, a
...
- This document exists under `docs/marketplace/` and is linked from the project
  navigation.
- The current `v3.2.0` single-plugin boundary, its `v2.2.0` introduction, and
