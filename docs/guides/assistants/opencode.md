<!-- migrated-from: docs/consumers/opencode-setup.md -->
...
5. Keep consumer-specific rules, private paths, endpoints, credentials,
   repository addresses, runtime flags, business rules, and private knowledge
   base content out of public templates and examples.
...
- If a selected safety check or validator is unavailable, report it as skipped
  or not run with the reason; do not loosen global permissions to bypass the
  missing tool.
