...
| [workflow-evaluation-record-2026-05-12.md](workflow-evaluation-record-2026-05-12.md) | Draft `v2.2.0` workflow evaluation record; manual command execution remains pending. |
