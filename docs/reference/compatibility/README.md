<!-- migrated-from: docs/compatibility/README.md -->
...
[../marketplace/compatibility-matrix.md](marketplace.md).
...
[maintainer release runbook](../../operations/releases/runbook.md#4-verify-as-a-consumer).
