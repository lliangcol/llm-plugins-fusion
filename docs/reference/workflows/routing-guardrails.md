<!-- migrated-from: docs/workflows/routing-validation-guardrails.md -->
...
- [Context-Safe Agent Workflows](../../guides/workflows/context-safe.md)
- [GSD-Informed Reliability Hardening](../../guides/workflows/hardening.md)
- [Verification Evidence Contract](verification-evidence.md)
- [Thin Harness, Fat Skills Workflow Doctrine](../architecture/skill-first-projection.md)
- [Checkpoint Artifact Prompt](../../templates/prompts/common/checkpoint-artifact.md)
- [Workbench Consumer Template](../../templates/consumer-profiles/workbench.md)
- [Security Review Route](../security/security-review.md)
- [Trust Policy](../security/marketplace-trust.md)
