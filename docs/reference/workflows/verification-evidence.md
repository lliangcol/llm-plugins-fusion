<!-- migrated-from: docs/workflows/verification-evidence-contract.md -->
...
[Checkpoint Artifact Prompt](../../templates/prompts/common/checkpoint-artifact.md) and
...
[Codex Final Verification Prompt](../../templates/prompts/codex/final-verification.md). A
...
| [Context-Safe Agent Workflows](../../guides/workflows/context-safe.md) | Review unit, fix loop, and checkpoint method. |
| [GSD-Informed Reliability Hardening](../../guides/workflows/hardening.md) | Maintenance note for the adopted hardening controls and non-goals. |
| [Routing and Validation Guardrails](routing-guardrails.md) | Maintenance guardrails for routing, checkpoint evidence, prompt budgets, and distribution-risk scanning. |
| [Serial Checkpoint Prompt](../../templates/prompts/claude-code/serial-checkpoint.md) | Claude Code prompt for one-unit-at-a-time work. |
| [Codex Final Verification Prompt](../../templates/prompts/codex/final-verification.md) | Codex prompt for verifying fixes against an existing review artifact. |
