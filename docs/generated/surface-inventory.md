...
| --- | --- |
| `.claude-plugin/marketplace.json` | `nova-plugin@3.0.1` |
| `.claude-plugin/marketplace.metadata.json` | `nova-plugin@3.0.1` |
| `docs/marketplace/catalog.md` | `nova-plugin@3.0.1` |
