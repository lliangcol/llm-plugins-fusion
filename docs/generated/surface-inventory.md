...
| --- | --- |
| `.claude-plugin/marketplace.json` | `nova-plugin@2.3.0` |
| `.claude-plugin/marketplace.metadata.json` | `nova-plugin@2.3.0` |
| `docs/marketplace/catalog.md` | `nova-plugin@2.3.0` |
