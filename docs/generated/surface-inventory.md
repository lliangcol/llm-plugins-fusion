...
| --- | --- |
| `.claude-plugin/marketplace.json` | `nova-plugin@2.4.0-rc.1` |
| `.claude-plugin/marketplace.metadata.json` | `nova-plugin@2.4.0-rc.1` |
| `docs/marketplace/catalog.md` | `nova-plugin@2.4.0-rc.1` |
