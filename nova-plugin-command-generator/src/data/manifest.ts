...
{{INPUT}}`,
    },
    {
      ...
      fields: [
        { id: 'PERSPECTIVE', label: 'Perspective', type: 'select', options: [{ value: 'observer', label: 'observer' }, { value: 'reviewer', label: 'reviewer' }], defaultValue: 'observer' },
        { id: 'INPUT', label: 'Input', type: 'multiline', required: true },
      ],
      template: `/explore
...
{{INPUT}}`,
    },
    {
      ...
      fields: [
        ...
        { id: 'DEPTH', label: 'Depth', type: 'select', options: [{ value: 'quick', label: 'quick' }, { value: 'normal', label: 'normal' }, { value: 'deep', label: 'deep' }], defaultValue: 'normal' },
...
{{RISKS}}`,
    },
    {
      ...
      fields: [
        { id: 'PLAN_TEXT', label: 'Plan text', type: 'multiline', required: true },
      ],
...
{{PLAN_TEXT}}`,
    },
    {
      ...
      fields: [
        { id: 'PLAN_OUTPUT_PATH', label: 'Plan output path', type: 'path', required: true },
        { id: 'PLAN_PROFILE', label: 'Plan profile', type: 'select', options: [{ value: 'general', label: 'general' }, { value: 'java-backend', label: 'java-backend' }], defaultValue: 'general' },
        { id: 'PLAN_INTENT', label: 'Plan intent', type: 'multiline', required: true },
...
{{CONSTRAINTS}}`,
    ...
    },
    {
      ...
      fields: [
        { id: 'ARGUMENTS', label: 'Input', type: 'multiline', required: true },
      ],
...
{{ARGUMENTS}}`,
    },
    {
      ...
      fields: [
        { id: 'LEVEL', label: 'Level', type: 'select', options: [{ value: 'standard', label: 'standard' }, { value: 'strict', label: 'strict' }], defaultValue: 'standard' },
        { id: 'INPUT', label: 'Input', type: 'multiline', required: true },
      ],
      template: `/review
LEVEL: {{LEVEL}}
